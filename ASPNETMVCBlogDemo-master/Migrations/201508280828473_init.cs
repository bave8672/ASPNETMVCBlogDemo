                ...
                c => new
                    {
                        ...
                        Content = c.Binary(),
                        ApplicationUserInfoId = c.Int(nullable: false),
                        ApplicationUserInfo_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ApplicationUserInfoes", t => t.ApplicationUserInfo_Id)
                .Index(t => t.ApplicationUserInfo_Id);
